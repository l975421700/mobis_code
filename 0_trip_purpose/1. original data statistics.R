...
load('/data/students/qigao/scratch/participants.RData')
...
# tp_inswiss_label$dayth <- ceiling(as.numeric(difftime(
#     tp_inswiss_label$started_at_local, as.Date("2019-09-02", tz="UTC"), units = 'days'
# )))
# ddd <- tp_inswiss_label[ , .N, by = .(user_id, dayth)]
# dim(ddd)[1]; dim(tp_inswiss_label)[1]
